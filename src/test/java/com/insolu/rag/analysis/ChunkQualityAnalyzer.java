package com.insolu.rag.analysis;
...
public class ChunkQualityAnalyzer {
    ...
    private static final String DB_URL = System.getProperty("db.url", "jdbc:postgresql://localhost:5432/insolu_rag");
    private static final String DB_USER = System.getProperty("db.user", "postgres");
    private static final String DB_PASS = System.getProperty("db.password", "123456");
